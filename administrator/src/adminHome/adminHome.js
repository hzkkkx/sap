...
class Main extends React.Component {
	...
	//根据路由判断 用户选择了菜单中的哪一项
	whoIsChecked(){
		if(this.props.location.pathname.indexOf('/adminHome/q_checkin') != -1) {//试题录入
		...
		else if(this.props.location.pathname.indexOf('/adminHome/choose_questions') != -1) {//试题查询
			this.setState({defaultSelectedKeys : ['choose_questions']})
		}
		else if(this.props.location.pathname.indexOf('/adminHome/score_search') != -1) {//成绩查询
			this.setState({defaultSelectedKeys : ['score_search']})
		}
		else if(this.props.location.pathname.indexOf('/adminHome/student_manage') != -1) {//学生管理
		...
		else if(this.props.location.pathname.indexOf('/adminHome/teacher_manage') != -1) {//教师管理
		...
		else if(this.props.location.pathname.indexOf('/adminHome/class_manage') != -1) {//班级管理
		...
		else if(this.props.location.pathname.indexOf('/adminHome/paper_manage') != -1) {//考试管理
		...
		else if(this.props.location.pathname.indexOf('/adminHome/personal_center') != -1) {//个人中心
